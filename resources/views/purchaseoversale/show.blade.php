    ...
    <x-titlePage title="Ventas/Compras de {{$family['name']?? ''}}">
        ...
        <form action ="{{route('purchaseoversale.show', $family['familyId'])}}" method="GET" class="flex flex-col md:flex-row md:space-x-4 justify-end">
            <div class="flex items-center space-x-2">
                <select id="dropdown" name="category" class="bg-gray-100 block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
