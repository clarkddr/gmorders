<x-guestLayout>
    ...
    {{--    <p class="text-gray-700 dark:text-gray-200">Instrucciones de uso</p>--}}
        ...
        <a target="_blank" href="{{route('styleSearch.search')}}" class="text-white bg-blue-700  px-2 py-2 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            🔎 Buscador de precios
        </a>
