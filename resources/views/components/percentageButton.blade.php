...
@if ($value == 0)
    <span class="px-3 py-1 text-{{$size}} font-medium leading-5 text-white transition-colors duration-150  border border-transparent rounded-md focus:outline-none ">
@elseif ($value > $max)
