            ...
            <table id="salesTable" class="w-full whitespace-no-wrap">
                ...
                @foreach ($thisYearSales as $tySales)
                    <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <td class="px-4 py-3">
                            <x-percentageButton below="red" above="green" :min="99" :max="100" :value="$tySales['saleVsGoal']"/>
                        </td>
                        ...
                        <td class="px-4 py-3 dt-text-left text-sm">{{ $tySales['purchaseVsSale'] }}%</td>
                        <td class="px-4 py-3">
                            {{$tySales['projection']['purchase']}}
                        </td>
                        <td class="px-4 py-3 dt-text-left text-sm">{{ $tySales['projection']['purchaseVsSale'] }}%</td>
                        <td class="px-4 py-3">
                ...
                <tr class="px-4 py-3 mb-3 text-xs font-semibold tracking-wide text-gray-500 uppercase border-t dark:border-gray-700 bg-gray-50 sm:grid-cols-9 dark:text-gray-400 dark:bg-gray-800">
                    ...
                    <td class="px-4 py-3 font-bold text-xl">
                        <x-percentageButton below="red" above="green" :min="99" :max="100" :value="$thisYearSalesTotal['saleVsGoal']" size="lg"/>
                    </td>
                    <td class="px-4 py-3">
                        <div class="flex flex-col items-end">
                    ...
                    <td class="px-4 py-3 font-bold text-xl dt-text-left"> {{ $thisYearSalesTotal['purchaseVsSale'] }}% </td>
                    <td class="px-4 py-3 text-xl font-bold">
                        {{$projectionSalesTotal['purchase']}}
                    </td>
                    <td class="px-4 py-3 font-bold text-xl dt-text-left"> {{ $projectionSalesTotal['purchaseVsSale'] }}% </td>
                    <td class="px-4 py-3">
